...
std::optional<NodeType> GraphSerializer::string_to_node_type(const std::string& type_str) {
    if (type_str == "Sphere") return NodeType::Sphere;
    if (type_str == "Box") return NodeType::Box;
    if (type_str == "Cylinder") return NodeType::Cylinder;
    if (type_str == "Plane") return NodeType::Plane;
    if (type_str == "Torus") return NodeType::Torus;
    if (type_str == "Extrude") return NodeType::Extrude;
    if (type_str == "Smooth") return NodeType::Smooth;
    if (type_str == "Subdivide") return NodeType::Subdivide;
    if (type_str == "Transform") return NodeType::Transform;
    if (type_str == "Array") return NodeType::Array;
    if (type_str == "Mirror") return NodeType::Mirror;
    if (type_str == "Boolean") return NodeType::Boolean;
    if (type_str == "Merge") return NodeType::Merge;
    if (type_str == "Switch") return NodeType::Switch;
    return std::nullopt;
}
