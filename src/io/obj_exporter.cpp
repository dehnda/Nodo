...
bool ObjExporter::export_mesh(const core::Mesh& mesh, const std::string& filename) {
...
std::optional<std::string> ObjExporter::mesh_to_obj_string(const core::Mesh& mesh) {
    if (mesh.empty()) {
        return std::nullopt;
    }
