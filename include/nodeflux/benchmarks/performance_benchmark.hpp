...
public:
    ...
    struct BenchmarkResult {
        ...
        BenchmarkResult() : average_time_ms(0), min_time_ms(0), max_time_ms(0), 
                           std_dev_ms(0), iterations(0), memory_usage_bytes(0) {}
    };
...
private:
    ...
    static std::optional<spatial::BVH::RayHit> brute_force_ray_intersect(
    ...
    static std::vector<int> brute_force_aabb_query(
