 ...
 * When a new command is pushed, it's executed immediately and added to the undo stack.
 * Supports command merging for smooth interactions (e.g., dragging, slider changes).
 */
class UndoStack {
public:
    UndoStack() = default;
