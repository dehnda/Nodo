 ...
 * 
 * This class extracts menu creation logic from MainWindow to improve organization.
 * It works as a helper - MainWindow still owns all actions and widgets, but 
 * MenuManager handles the setup details.
 */
class MenuManager {
public:
