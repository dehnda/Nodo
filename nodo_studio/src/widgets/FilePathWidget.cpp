...
FilePathWidget::FilePathWidget(const QString &label, const QString &initial_path,
                               Mode mode, const QString &filter,
...
QWidget* FilePathWidget::createControlWidget() {
  ...
  connect(path_edit_, &QLineEdit::textChanged,
          this, &FilePathWidget::onPathEdited);
  ...
  connect(browse_button_, &QPushButton::clicked,
          this, &FilePathWidget::onBrowseClicked);
...
void FilePathWidget::setMode(Mode mode) {
  mode_ = mode;
}
