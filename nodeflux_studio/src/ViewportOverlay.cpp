...
void ViewportStatsOverlay::setupUI() {
  ...
  fps_label_->setStyleSheet("QLabel {"
                            "   color: #4a9eff;"
                            "   font-size: 12px;"
  ...
  tris_label_->setStyleSheet("QLabel {"
                             "   color: #a0a0a8;"
                             "   font-size: 12px;"
                             "   font-family: 'SF Mono', 'Consolas', monospace;"
                             "}");
  ...
  // Overall styling
  setStyleSheet("ViewportStatsOverlay {"
...
void ViewportControlsOverlay::setupUI() {
  ...
  wireframe_btn_->setIcon(nodeflux_studio::Icons::get(
      nodeflux_studio::IconManager::Icon::Wireframe));
  wireframe_btn_->setCheckable(true);
  wireframe_btn_->setToolTip("Toggle Wireframe");
  wireframe_btn_->setFixedSize(40, 40);
  wireframe_btn_->setStyleSheet("QPushButton {"
  ...
  shaded_btn_->setIcon(
      nodeflux_studio::Icons::get(nodeflux_studio::IconManager::Icon::Sphere));
  ...
  shaded_btn_->setStyleSheet("QPushButton {"
                             "   background: rgba(0, 0, 0, 0.6);"
                             "   border: 1px solid rgba(255, 255, 255, 0.1);"
                             "   border-radius: 8px;"
                             "   color: #e0e0e0;"
  ...
  reset_camera_btn_->setIcon(nodeflux_studio::Icons::get(
      nodeflux_studio::IconManager::Icon::ResetCamera));
  ...
  fit_view_btn_->setIcon(
      nodeflux_studio::Icons::get(nodeflux_studio::IconManager::Icon::FitView));
...
void ViewportAxisGizmo::setupUI() {
  ...
  setStyleSheet("ViewportAxisGizmo {"
                "   background: rgba(0, 0, 0, 0.6);"
                "   border: 1px solid rgba(255, 255, 255, 0.1);"
                "   border-radius: 40px;"
                "}");
