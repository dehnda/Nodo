...
public:
  ...
  static std::optional<core::GeometryContainer> generate_uv_sphere(double radius = 1.0, int u_segments = 32,
                                                                   int v_segments = 16);
  ...
  static std::optional<core::GeometryContainer> generate_icosphere(double radius = 1.0, int subdivisions = 2);
...
private:
  ...
  static void subdivide_triangle(const Eigen::Vector3d& v1, const Eigen::Vector3d& v2, const Eigen::Vector3d& v3,
                                 std::vector<Eigen::Vector3d>& vertices, std::vector<std::array<int, 3>>& faces,
                                 int level);

  static Eigen::Vector3d normalize_vertex(const Eigen::Vector3d& vertex, double radius);
};
