...
struct StandardAttributeInfo {
  ...
  constexpr StandardAttributeInfo(std::string_view n, AttributeType t,
                                   ElementClass e,
...
constexpr StandardAttributeInfo Cd{standard_attrs::Cd, AttributeType::VEC3F,
                                    ElementClass::POINT};
constexpr StandardAttributeInfo Alpha{standard_attrs::Alpha,
                                       AttributeType::FLOAT,
                                       ElementClass::POINT};
constexpr StandardAttributeInfo pscale{standard_attrs::pscale,
                                        AttributeType::FLOAT,
                                        ElementClass::POINT};
...
constexpr StandardAttributeInfo material_id{
    ...
    InterpolationMode::DISCRETE};
constexpr StandardAttributeInfo material{standard_attrs::material,
...
// Detail attributes
constexpr StandardAttributeInfo bounds_min{standard_attrs::bounds_min,
                                            AttributeType::VEC3F,
                                            ElementClass::DETAIL};
constexpr StandardAttributeInfo bounds_max{standard_attrs::bounds_max,
                                            AttributeType::VEC3F,
                                            ElementClass::DETAIL};
...
constexpr StandardAttributeInfo time{standard_attrs::time, AttributeType::FLOAT,
                                      ElementClass::DETAIL};
constexpr StandardAttributeInfo name{standard_attrs::name,
                                      AttributeType::STRING,
                                      ElementClass::DETAIL,
                                      InterpolationMode::DISCRETE};

// Specialized attributes
constexpr StandardAttributeInfo transform{standard_attrs::transform,
                                           AttributeType::MATRIX4,
                                           ElementClass::POINT};
constexpr StandardAttributeInfo orient{standard_attrs::orient,
...
constexpr StandardAttributeInfo up{standard_attrs::up, AttributeType::VEC3F,
                                    ElementClass::POINT};
constexpr StandardAttributeInfo rest_P{standard_attrs::rest_P,
                                        AttributeType::VEC3F,
                                        ElementClass::POINT};
constexpr StandardAttributeInfo rest_N{standard_attrs::rest_N,
                                        AttributeType::VEC3F,
                                        ElementClass::VERTEX};
...
inline bool is_standard_attribute(std::string_view attr_name) {
  ...
  return attr_name == standard_attrs::P || attr_name == standard_attrs::N ||
         ...
         attr_name == standard_attrs::v ||
         attr_name == standard_attrs::Alpha ||
