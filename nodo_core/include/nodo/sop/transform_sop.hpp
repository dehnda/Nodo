...
public:
  ...
  void set_translation(double x, double y, double z) {
    set_parameter("translate", Eigen::Vector3f(static_cast<float>(x), static_cast<float>(y), static_cast<float>(z)));
  }
  ...
  void set_rotation(double x, double y, double z) {
    set_parameter("rotate", Eigen::Vector3f(static_cast<float>(x), static_cast<float>(y), static_cast<float>(z)));
  }
  ...
  void set_scale(double x, double y, double z) {
    set_parameter("scale", Eigen::Vector3f(static_cast<float>(x), static_cast<float>(y), static_cast<float>(z)));
  }
  ...
  Eigen::Vector3d get_translation() const {
    auto vec = get_parameter<Eigen::Vector3f>("translate", Eigen::Vector3f(0.0F, 0.0F, 0.0F));
    return {vec.x(), vec.y(), vec.z()};
  }
  Eigen::Vector3d get_rotation() const {
    auto vec = get_parameter<Eigen::Vector3f>("rotate", Eigen::Vector3f(0.0F, 0.0F, 0.0F));
    return {vec.x(), vec.y(), vec.z()};
  }
  Eigen::Vector3d get_scale() const {
    auto vec = get_parameter<Eigen::Vector3f>("scale", Eigen::Vector3f(1.0F, 1.0F, 1.0F));
    return {vec.x(), vec.y(), vec.z()};
  }
