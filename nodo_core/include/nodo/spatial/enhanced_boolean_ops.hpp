...
public:
  ...
  static std::optional<core::Mesh> union_meshes(const core::Mesh& mesh_a,
  ...
  intersect_meshes(const core::Mesh& mesh_a, const core::Mesh& mesh_b,
                   const BooleanParams& params);
  ...
  /// @param params Operation parameters
  /// @return Result mesh or nullopt on failure
  static std::optional<core::Mesh> subtract_meshes(const core::Mesh& mesh_a,
                                                   const core::Mesh& mesh_b,
                                                   const BooleanParams& params);
  ...
  static bool meshes_intersect(const core::Mesh& mesh_a,
                               const core::Mesh& mesh_b);
  ...
  find_intersection_points(const core::Mesh& mesh_a, const core::Mesh& mesh_b);
  ...
  static std::optional<core::Mesh>
  prepare_mesh_for_boolean(const core::Mesh& mesh, const BooleanParams& params);
...
private:
  ...
  static std::unique_ptr<BVH> build_mesh_bvh(const core::Mesh& mesh,
                                             const BooleanParams& params);

  /// @brief Validate mesh for boolean operations
  static bool validate_mesh_for_boolean(const core::Mesh& mesh,
                                        const BooleanParams& params);

  /// @brief Post-process boolean operation result
  static std::optional<core::Mesh>
  post_process_result(const core::Mesh& result, const BooleanParams& params);
};
